    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main className="mx-auto flex max-w-6xl flex-col gap-12 px-4 py-12">
                <section className="grid gap-8 rounded-tl-[36px] rounded-br-[36px] rounded-tr-none rounded-bl-none bg-linear-to-r from-[#1b8f35] to-[#4ad14e] px-8 py-12 text-white shadow-card lg:grid-cols-2 lg:items-center">
                ...
                <section className="space-y-6 text-center text-brand">
                    ...
                    <p className="text-sm text-brand/70">
                        ...
                        manfaat lengkap yang dibutuhkan kulitmu.
                    </p>
                </section>
