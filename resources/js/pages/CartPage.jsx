        ...
        <div className="min-h-screen bg-[#f9f9f9] font-sans">
            ...
            <main className="mx-auto max-w-6xl px-4 py-12">
                ...
                <div className="mb-8 flex items-center gap-4">
                    <svg
                        viewBox="0 0 24 24"
                        className="h-10 w-10 text-[#4aa731]"
                        fill="currentColor"
                    >
                        ...
                        {items.map((item) => (
                            ...
                            >
                                ...
                                <div
                                    ...
                                    className={`flex h-8 w-8 cursor-pointer items-center justify-center rounded border-2 ${
                                        item.checked
                                            ? "border-[#4aa731] bg-[#4aa731]"
                                            : "border-gray-300"
                                    }`}
                                >
                                    {item.checked && (
                                ...
                                <div className="flex flex-1 flex-col justify-between sm:flex-row sm:items-center">
                                    ...
                                    <div className="mt-4 flex items-center gap-4 sm:mt-0">
                                        ...
                                        <span className="text-xl font-bold text-[#4aa731]">
                                            {item.quantity}
                                        </span>
                                        <button
                                            onClick={() =>
