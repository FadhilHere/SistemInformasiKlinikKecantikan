    ...
    const events = [
        {
            ...
            date: "23 Nov 2025",
            description:
                "Bakal Di Adain Di Kampus Ternama Di Riau Yaitu PCR Untuk Penjelasan Nya.....",
    ...
    return (
        <div className="min-h-screen bg-background font-sans">
            ...
            <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                {/* Hero Section */}
                <div className="relative mb-12 overflow-hidden rounded-3xl bg-linear-to-r from-primary to-[#7ce645] p-8 text-white shadow-lg md:p-12">
                    ...
                    <div className="absolute top-0 right-0 h-full w-1/3 opacity-20">
                        ...
                        >
                            <path
                                fill="#FFFFFF"
                                d="M45.7,-76.3C58.9,-69.3,69.1,-55.6,76.3,-41.2C83.5,-26.8,87.6,-11.7,85.6,2.6C83.6,16.9,75.4,30.4,66.1,42.5C56.8,54.6,46.3,65.3,34.1,71.5C21.9,77.7,8,79.4,-4.6,77.3C-17.2,75.2,-28.5,69.3,-39.3,61.9C-50.1,54.5,-60.4,45.6,-68.6,34.7C-76.8,23.8,-82.9,10.9,-81.8,-1.5C-80.7,-13.9,-72.4,-25.8,-63.1,-36.1C-53.8,-46.4,-43.5,-55.1,-32.2,-63.1C-20.9,-71.1,-8.6,-78.4,5.1,-81.3C18.8,-84.2,32.5,-83.3,45.7,-76.3Z"
                ...
                <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="flex flex-wrap items-center gap-2">
                        <span className="mr-2 text-lg font-bold text-brand">
                            Event:
                        </span>
