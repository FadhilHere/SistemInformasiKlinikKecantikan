            ...
            <main>
                ...
                <section className="mx-auto max-w-6xl px-4 py-16">
                    ...
                    <p className="text-justify text-lg leading-relaxed text-gray-600">
                        Dengan Rangkaian Produk Yang Diformulasikan Khusus Untuk
                        Perawatan Kulit Wajah, MISCHE Skincare Menghadirkan
                        Manfaat Lengkap Yang Dibutuhkan Kulitmu. Mulai Dari
                        Mencerahkan Warna Kulit, Menjaga Kelembapan Optimal,
                        Hingga Mengatasi Tanda-Tanda Penuaan Dini. Produk Klinik
                        Mische Juga Efektif Dalam Merawat Kulit Berjerawat Dan
                        Membantu Mengembalikan Kilau Alami Wajahmu. Jangan Harga
                        Yang Terjangkau, Klinik Mische Menjadi Pilihan Tepat
                        Bagi Kamu Yang Ingin Merawat Kulit Secara Menyeluruh Dan
                        ...
                        <div className="flex w-full flex-col gap-8 md:w-1/2">
                            <div>
                                ...
                                <p className="text-gray-600">
                                    Dengan Rangkaian Produk Yang Diformulasikan
                                    Khusus Untuk Perawatan Kulit Wajah, MISCHE
                                    Skincare Menghadirkan Manfaat Lengkap Yang
                                    Dibutuhkan Kulitmu. Mulai Dari Mencerahkan
                                    Warna Kulit, Menjaga Kelembapan Optimal.
                                </p>
                            </div>
                            <div>
                                <h3 className="mb-4 text-2xl font-bold text-black">
                ...
                <section className="relative overflow-hidden bg-[#4aa731] py-16 text-white">
                    ...
                    <div
                        className="absolute left-0 top-0 h-16 w-full bg-white"
                        style={{ clipPath: "ellipse(60% 100% at 50% 0%)" }}
                    ></div>

                    <div className="mx-auto max-w-6xl px-4 text-center">
                        <h2 className="mb-2 text-3xl font-bold">
                            Inilah Kegiatan Harian Kami Dalam Memberikan
                        </h2>
                        <h2 className="mb-4 text-3xl font-bold">
                            Perawatan Terbaik.
                        </h2>
                        <p className="mb-12 text-sm font-medium tracking-widest opacity-80">
