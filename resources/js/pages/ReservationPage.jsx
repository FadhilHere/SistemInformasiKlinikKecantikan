        ...
        <div className="relative w-full" ref={containerRef}>
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    <span className="text-right text-sm font-bold text-black">
                        {options.find((o) => o.value === value)?.label || value}
                    </span>
                    <svg
                        className={`h-4 w-4 text-[#4aa731] transition-transform duration-200 ${
                            isOpen ? "rotate-180" : ""
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
        ...
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-md rounded-[40px] bg-white p-8 text-center shadow-2xl">
                ...
                <div className="flex justify-center gap-4">
                    <button
                        onClick={onConfirm}
                        className="min-w-[120px] rounded-xl bg-[#53c41a] px-6 py-3 font-bold text-white transition hover:bg-[#4aa731]"
                    >
                        Ya
                    </button>
                    <button
                        onClick={onClose}
                        className="min-w-[160px] rounded-xl border border-gray-300 bg-white px-6 py-3 font-bold text-black transition hover:bg-gray-50"
                    >
                        Tidak, Batalkan
                    </button>
                </div>
        ...
        <div className="min-h-screen bg-[#f9f9f9] font-sans">
            ...
            <main className="mx-auto max-w-6xl px-4 py-12">
                {bookingStep === "schedule" ? (
                    <>
                        {/* Banner Schedule */}
                        <div className="relative mb-8 overflow-hidden rounded-3xl bg-linear-to-r from-[#4aa731] to-[#65ce4d] p-8 text-white shadow-lg md:p-12">
                            <div className="relative z-10 max-w-2xl">
                                <h1 className="text-3xl font-bold leading-tight md:text-4xl">
                                    Jadwal Reservasi Treatment <br /> Di Klinik
                                    Kecantikan Mische
                                </h1>
                            </div>
                        ...
                        <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-4">
                            ...
                            <div className="flex w-full items-center justify-center rounded-full bg-white px-4 py-2 font-bold shadow-sm">
                                ...
                                <span className="text-sm">
                                    {isDoctorAvailable ? availableCount : 0}
                                </span>
                            </div>
                            <div className="flex w-full items-center justify-center rounded-full bg-white px-4 py-2 font-bold shadow-sm">
                                <span className="mr-2 text-sm font-medium text-gray-600">
                                ...
                                <span className="text-sm">
                                    {isDoctorAvailable ? bookedCount : 0}
                                </span>
                            </div>
                        </div>
                            ...
                            {isDoctorAvailable ? (
                                ...
                                <div className="flex h-full flex-col items-center justify-center py-20">
                                    <div className="mb-6 rounded-full border-4 border-[#4aa731] p-4">
                                        <span className="text-6xl font-bold text-[#4aa731]">
                                            !
                                        </span>
                                    </div>
