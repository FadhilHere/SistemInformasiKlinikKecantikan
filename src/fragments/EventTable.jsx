...
const INITIAL_EVENTS = [
    {
        id: 1,
        name: 'Grand Opening Cabang Baru',
        description: 'Peresmian cabang baru di Jakarta Selatan dengan promo spesial.',
    ...
    {
        id: 2,
        name: 'Beauty Fair 2024',
        description: 'Pameran produk kecantikan tahunan dan konsultasi gratis.',
                    ...
                    <tbody>
                        {events.map((event, index) => (
                            <tr key={event.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                                ...
                                <td className="py-4 px-6 text-gray-500 max-w-xs truncate">{event.description}</td>
                                <td className="py-4 px-6 text-gray-500 whitespace-nowrap">{formatDate(event.startDate)}</td>
                                <td className="py-4 px-6 text-gray-500 whitespace-nowrap">{formatDate(event.endDate)}</td>
                                <td className="py-4 px-6 text-gray-900">{event.location}</td>
